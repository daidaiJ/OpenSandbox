...
OPEN_SANDBOX_RUNTIME_ID_HEADER = "OpenSandbox-Runtime-Id"
SANDBOX_RUNTIME_ID_ANNOTATION_KEY = "sandbox.opensandbox.io/runtime-id"
SANDBOX_ALLOC_STATUS_ANNOTATION_KEY = "sandbox.opensandbox.io/alloc-status"
SANDBOX_SESSION_SYNC_ANNOTATION_KEY = "sandbox.opensandbox.io/session-sync"
SESSION_SYNC_PENDING = "pending"
SESSION_SYNC_PREPARED = "prepared"
...
class SandboxErrorCodes:
    ...
    # Proxy runtime identity (silent rebuild / #954 perception)
    RUNTIME_LOST = "SANDBOX::RUNTIME_LOST"
    RUNTIME_REPLACED = "SANDBOX::RUNTIME_REPLACED"
    SESSION_NOT_PREPARED = "SANDBOX::SESSION_NOT_PREPARED"
    SESSION_PREPARE_FAILED = "KUBERNETES::SESSION_PREPARE_FAILED"
    K8S_POD_NOT_FOUND = "KUBERNETES::POD_NOT_FOUND"
